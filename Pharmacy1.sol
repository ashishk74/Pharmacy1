...
function mm03(uint _partno) external view returns(string memory, string memory, string memory, string memory, uint){
...
function mk03(string memory _gst) public view returns(string memory, uint, string memory, string memory, address){
...
public returns(bool) {
 ...
 // view infoRecord
    ...
    mapping (uint => mapping (uint => materialReceipt)) MRN;
    ...
    public returns (uint , string memory){
     ...
     MRN[_partno][_vcode] = materialReceipt(now, _partno, _qty, _uom, _vcode, _invdate, _invno, materialreceiptno, _batchno, _expiry,
    ...
    function counterSale (uint _partno, uint _qty) public returns (uint){
    ...
    function stockOut(uint _partno) public returns(uint) {
    ...
    function MRP() public returns(bool){
